          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col justify-center text-left space-y-6 order-1 md:order-2 animate-in fade-in slide-in-from-right-8 duration-1000">
              <div>
                ...
                <h1 className="text-4xl sm:text-6xl md:text-8xl font-serif font-black uppercase leading-none tracking-tighter text-black">
                  3M
                </h1>
              </div>
              
              <p className="text-lg md:text-xl font-bold uppercase tracking-[0.2em] text-black">
                Corte - Barba - Sobrancelha - Manicure
              </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-lg text-neutral-600 max-w-2xl mx-auto font-medium">
              Mais que um corte, uma experiência. No Estúdio 3M, unimos a tradição da barbearia clássica com a praticidade moderna.
            </p>
          </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[portfolio1, portfolio2, portfolio3].map((img, i) => (
              <div key={i} className="group relative border-4 border-black overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all">
                <img 
                  src={img} 
                  alt={`Portfolio ${i+1}`} 
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          <div>
            ...
            <p className="text-neutral-400 text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
              O visual clássico com a atitude moderna. 
              Profissionais experientes e ambiente autêntico.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-300">
              <li className="font-medium text-white text-lg">(79) 99660-4308</li>
              <li>@estudio3m.aju</li>
              <li>Aracaju - SE</li>
            </ul>
          </div>
